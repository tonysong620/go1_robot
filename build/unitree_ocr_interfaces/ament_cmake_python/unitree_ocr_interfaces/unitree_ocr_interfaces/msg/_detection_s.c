...
bool unitree_ocr_interfaces__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_ocr_interfaces.msg._detection.Detection", full_classname_dest, 47) == 0);
  }
  unitree_ocr_interfaces__msg__Detection * ros_message = _ros_message;
  {  // text
...
PyObject * unitree_ocr_interfaces__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_ocr_interfaces.msg._detection");
