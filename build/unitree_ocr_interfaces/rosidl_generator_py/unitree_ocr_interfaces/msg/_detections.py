...
class Metaclass_Detections(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('unitree_ocr_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'unitree_ocr_interfaces.msg.Detections')
            logger.debug(
            ...
            from unitree_ocr_interfaces.msg import Detection
...
class Detections(metaclass=Metaclass_Detections):
    ...
    _fields_and_field_types = {
        'data': 'sequence<unitree_ocr_interfaces/Detection>',
        'count': 'uint16',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['unitree_ocr_interfaces', 'msg'], 'Detection')),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'data' field must be a set or sequence and each value of type 'Detection'"
        self._data = value
