...
#include "unitree_ocr_interfaces/msg/detail/detections__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const unitree_ocr_interfaces::msg::Detection &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  unitree_ocr_interfaces::msg::Detection &);
...
cdr_serialize(
  const unitree_ocr_interfaces::msg::Detections & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data
  {
    ...
    for (size_t i = 0; i < size; i++) {
      unitree_ocr_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.data[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  unitree_ocr_interfaces::msg::Detections & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
    ...
    for (size_t i = 0; i < size; i++) {
      unitree_ocr_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        unitree_ocr_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        unitree_ocr_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection(
  ...
  if (is_plain) {
    ...
    using DataType = unitree_ocr_interfaces::msg::Detections;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unitree_ocr_interfaces::msg::Detections *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unitree_ocr_interfaces::msg::Detections *>(
    untyped_ros_message);
...
{
  return &unitree_ocr_interfaces::msg::typesupport_fastrtps_cpp::_Detections__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unitree_ocr_interfaces, msg, Detections)() {
  return &unitree_ocr_interfaces::msg::typesupport_fastrtps_cpp::_Detections__handle;
}
