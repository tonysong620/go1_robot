...
{
  new (message_memory) unitree_ocr_interfaces::msg::Detection(_init);
}

void Detection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unitree_ocr_interfaces::msg::Detection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detection_message_member_array[2] = {
  {
    ...
    offsetof(unitree_ocr_interfaces::msg::Detection, text),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_ocr_interfaces::msg::Detection, count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detection_message_members = {
  ...
  2,  // number of fields
  sizeof(unitree_ocr_interfaces::msg::Detection),
...
{
  return &::unitree_ocr_interfaces::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
